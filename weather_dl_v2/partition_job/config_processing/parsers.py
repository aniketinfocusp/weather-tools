...
def prepare_target_name_by_selection(selection: dict, partition_keys: t.List[str], target_path: str) -> str:
    partition_dict = OrderedDict(
        (key, typecast(key, selection[key][0])) for key in partition_keys
    )
